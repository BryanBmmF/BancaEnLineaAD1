...
public class SolicitudesTarjetasDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${fechaVerificacion}"));
        columnBinding.setColumnName("Fecha Verificacion");
        columnBinding.setColumnClass(java.sql.Timestamp.class);
        columnBinding.setEditable(false);
